...
3. Activate the conda environment with ```conda activate r3dg```.
4. Run gui.py with ```-t neilf_composite```. For example:
...
5. Use the left and right arrow keys to change the rotation of the environment light.
